...
export const teams: Team[] = [
  ...
  { id:'turkey', name:'土耳其', nameEn:'Turkey', flag:'🇹🇷', group:'D', fifaRank:37, elo:1720, coach:'Vincenzo Montella', keyPlayers:['Hakan Çalhanoğlu','Arda Güler','Cenk Tosun'], recentForm:['W','W','L','W','D'], recentResults:['3-0 vs Latvia','2-1 vs Croatia','0-1 vs Portugal','4-0 vs Armenia','2-2 vs Wales'], worldCupApps:3, bestResult:'季军 (2002)', groupStageOdds:2.50, winOdds:126 },
  ...
  // === GROUP H ===
  { id:'spain', name:'西班牙', nameEn:'Spain', flag:'🇪🇸', group:'H', fifaRank:5, elo:2020, coach:'Luis de la Fuente', keyPlayers:['Lamine Yamal','Pedri','Rodri'], recentForm:['W','W','W','W','W'], recentResults:['2-0 vs Germany','3-0 vs Georgia','4-1 vs Cyprus','2-0 vs Scotland','5-0 vs Andorra'], worldCupApps:17, bestResult:'冠军 (2010)', groupStageOdds:1.04, winOdds:8.5 },
