...
export const teams: Team[] = [
  ...
  // === GROUP D ===
  { id:'brazil', name:'巴西', nameEn:'Brazil', flag:'🇧🇷', group:'D', fifaRank:3, elo:2080, coach:'Dorival Júnior', keyPlayers:['Neymar Jr','Vinícius Júnior','Rodrygo'], recentForm:['W','W','W','D','W'], recentResults:['4-0 vs Peru','2-1 vs Colombia','3-0 vs Bolivia','1-1 vs Uruguay','5-1 vs Ecuador'], worldCupApps:23, bestResult:'冠军 (1958-2002共5次)', groupStageOdds:1.04, winOdds:5.5 },
