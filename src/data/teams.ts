// 2026 FIFA World Cup - 48 Teams (corrected per FIFA official groups)
...
export const groups: GroupInfo[] = [
  { name: 'A', teams: ['mexico', 'south-korea', 'czech', 'south-africa'] },
  { name: 'B', teams: ['canada', 'qatar', 'switzerland', 'bosnia'] },
  { name: 'C', teams: ['brazil', 'haiti', 'scotland', 'morocco'] },
  { name: 'D', teams: ['usa', 'australia', 'turkey', 'paraguay'] },
  { name: 'E', teams: ['germany', 'ivory-coast', 'ecuador', 'curacao'] },
  { name: 'F', teams: ['netherlands', 'sweden', 'tunisia', 'japan'] },
  { name: 'G', teams: ['belgium', 'iran', 'new-zealand', 'egypt'] },
  { name: 'H', teams: ['spain', 'saudi-arabia', 'uruguay', 'cape-verde'] },
  { name: 'I', teams: ['france', 'iraq', 'norway', 'senegal'] },
  { name: 'J', teams: ['argentina', 'austria', 'jordan', 'algeria'] },
  { name: 'K', teams: ['portugal', 'uzbekistan', 'colombia', 'dr-congo'] },
  { name: 'L', teams: ['england', 'ghana', 'panama', 'croatia'] },
];

export const teams: Team[] = [
  // === GROUP A ===
  { id:'mexico', name:'墨西哥', nameEn:'Mexico', flag:'🇲🇽', group:'A', fifaRank:14, elo:1860, coach:'Javier Aguirre', keyPlayers:['Santiago Giménez','Edson Álvarez','Hirving Lozano'], recentForm:['W','W','W','D','L'], recentResults:['2-0 vs Honduras','3-1 vs El Salvador','1-0 vs Costa Rica','1-1 vs USA','0-2 vs Argentina'], worldCupApps:18, bestResult:'八强 (1970, 1986)', groupStageOdds:1.40, winOdds:81 },
  ...
  // === GROUP C ===
  { id:'brazil', name:'巴西', nameEn:'Brazil', flag:'🇧🇷', group:'C', fifaRank:3, elo:2080, coach:'Dorival Júnior', keyPlayers:['Neymar Jr','Vinícius Júnior','Rodrygo'], recentForm:['W','W','W','D','W'], recentResults:['4-0 vs Peru','2-1 vs Colombia','3-0 vs Bolivia','1-1 vs Uruguay','5-1 vs Ecuador'], worldCupApps:23, bestResult:'冠军 (1958-2002共5次)', groupStageOdds:1.04, winOdds:7.5 },
  { id:'haiti', name:'海地', nameEn:'Haiti', flag:'🇭🇹', group:'C', fifaRank:86, elo:1490, coach:'Sébastien Migné', keyPlayers:['Frantzdy Pierrot','Duckens Nazon','Carlens Arcus'], recentForm:['L','W','L','L','D'], recentResults:['0-2 vs Canada','2-1 vs Cuba','0-3 vs Costa Rica','1-2 vs Suriname','1-1 vs Grenada'], worldCupApps:2, bestResult:'小组赛 (1974)', groupStageOdds:12.00, winOdds:2001 },
  { id:'scotland', name:'苏格兰', nameEn:'Scotland', flag:'🏴󠁧󠁢󠁳󠁣󠁴󠁿', group:'C', fifaRank:30, elo:1755, coach:'Steve Clarke', keyPlayers:['Andrew Robertson','Scott McTominay','Billy Gilmour'], recentForm:['W','W','L','D','W'], recentResults:['2-0 vs Norway','3-0 vs Cyprus','1-2 vs Spain','1-1 vs Georgia','2-0 vs Ireland'], worldCupApps:9, bestResult:'小组赛', groupStageOdds:3.50, winOdds:251 },
  { id:'morocco', name:'摩洛哥', nameEn:'Morocco', flag:'🇲🇦', group:'C', fifaRank:13, elo:1870, coach:'Walid Regragui', keyPlayers:['Achraf Hakimi','Brahim Díaz','Youssef En-Nesyri'], recentForm:['W','W','W','L','W'], recentResults:['2-0 vs Algeria','3-1 vs Zambia','1-0 vs Egypt','0-2 vs Spain','2-1 vs Ivory Coast'], worldCupApps:7, bestResult:'第四名 (2022)', groupStageOdds:1.50, winOdds:41 },

  // === GROUP D ===
  { id:'usa', name:'美国', nameEn:'USA', flag:'🇺🇸', group:'D', fifaRank:11, elo:1880, coach:'Mauricio Pochettino', keyPlayers:['Christian Pulisic','Giovanni Reyna','Folarin Balogun'], recentForm:['W','W','L','W','W'], recentResults:['3-0 vs Trinidad','2-0 vs Canada','0-1 vs Colombia','4-1 vs Grenada','2-0 vs Panama'], worldCupApps:12, bestResult:'季军 (1930)', groupStageOdds:1.25, winOdds:34 },
  { id:'australia', name:'澳大利亚', nameEn:'Australia', flag:'🇦🇺', group:'D', fifaRank:23, elo:1790, coach:'Graham Arnold', keyPlayers:['Mathew Ryan','Harry Souttar','Riley McGree'], recentForm:['W','L','W','D','W'], recentResults:['2-0 vs UAE','1-3 vs Japan','3-0 vs Palestine','1-1 vs South Korea','2-1 vs Bahrain'], worldCupApps:7, bestResult:'16强 (2006, 2022)', groupStageOdds:2.50, winOdds:251 },
  { id:'turkey', name:'土耳其', nameEn:'Turkey', flag:'🇹🇷', group:'D', fifaRank:37, elo:1720, coach:'Vincenzo Montella', keyPlayers:['Hakan Çalhanoğlu','Arda Güler','Cenk Tosun'], recentForm:['W','W','L','W','D'], recentResults:['3-0 vs Latvia','2-1 vs Croatia','0-1 vs Portugal','4-0 vs Armenia','2-2 vs Wales'], worldCupApps:3, bestResult:'季军 (2002)', groupStageOdds:2.50, winOdds:151 },
  { id:'paraguay', name:'巴拉圭', nameEn:'Paraguay', flag:'🇵🇾', group:'D', fifaRank:48, elo:1645, coach:'Daniel Garnero', keyPlayers:['Miguel Almirón','Julio Enciso','Gustavo Gómez'], recentForm:['L','W','D','W','L'], recentResults:['0-1 vs Argentina','2-0 vs Bolivia','1-1 vs Chile','2-1 vs Peru','0-3 vs Brazil'], worldCupApps:9, bestResult:'八强 (2010)', groupStageOdds:6.00, winOdds:501 },

  // === GROUP E ===
  { id:'germany', name:'德国', nameEn:'Germany', flag:'🇩🇪', group:'E', fifaRank:8, elo:1950, coach:'Julian Nagelsmann', keyPlayers:['Jamal Musiala','Florian Wirtz','Kai Havertz'], recentForm:['W','W','W','W','L'], recentResults:['3-1 vs Netherlands','2-0 vs France','4-0 vs Hungary','2-1 vs Bosnia','0-2 vs Spain'], worldCupApps:21, bestResult:'冠军 (1954-2014共4次)', groupStageOdds:1.04, winOdds:10 },
  ...
  // === GROUP G ===
  { id:'belgium', name:'比利时', nameEn:'Belgium', flag:'🇧🇪', group:'G', fifaRank:3, elo:1990, coach:'Domenico Tedesco', keyPlayers:['Kevin De Bruyne','Romelu Lukaku','Jérémy Doku'], recentForm:['W','W','W','D','W'], recentResults:['3-0 vs Austria','2-1 vs Italy','4-0 vs San Marino','1-1 vs Netherlands','2-0 vs Sweden'], worldCupApps:15, bestResult:'季军 (2018)', groupStageOdds:1.04, winOdds:15 },
  { id:'iran', name:'伊朗', nameEn:'Iran', flag:'🇮🇷', group:'G', fifaRank:20, elo:1810, coach:'Amir Ghalenoei', keyPlayers:['Mehdi Taremi','Sardar Azmoun','Alireza Jahanbakhsh'], recentForm:['W','W','W','L','W'], recentResults:['3-0 vs UAE','2-1 vs Qatar','4-0 vs Hong Kong','0-1 vs Japan','2-0 vs Uzbekistan'], worldCupApps:7, bestResult:'小组赛', groupStageOdds:3.00, winOdds:401 },
  { id:'new-zealand', name:'新西兰', nameEn:'New Zealand', flag:'🇳🇿', group:'G', fifaRank:92, elo:1480, coach:'Darren Bazeley', keyPlayers:['Chris Wood','Sarpreet Singh','Liberato Cacace'], recentForm:['W','W','L','D','W'], recentResults:['2-0 vs Solomon Is.','3-1 vs Fiji','0-3 vs Australia','1-1 vs Tahiti','2-1 vs PNG'], worldCupApps:3, bestResult:'小组赛', groupStageOdds:10.00, winOdds:2001 },
  { id:'egypt', name:'埃及', nameEn:'Egypt', flag:'🇪🇬', group:'G', fifaRank:33, elo:1740, coach:'Hossam Hassan', keyPlayers:['Mohamed Salah','Omar Marmoush','Trézéguet'], recentForm:['W','D','W','L','W'], recentResults:['2-1 vs Burkina Faso','1-1 vs Ghana','3-0 vs Djibouti','0-1 vs Morocco','2-0 vs Ethiopia'], worldCupApps:4, bestResult:'小组赛', groupStageOdds:3.00, winOdds:251 },

  // === GROUP H ===
  { id:'spain', name:'西班牙', nameEn:'Spain', flag:'🇪🇸', group:'H', fifaRank:5, elo:2020, coach:'Luis de la Fuente', keyPlayers:['Lamine Yamal','Pedri','Rodri'], recentForm:['W','W','W','W','W'], recentResults:['2-0 vs Germany','3-0 vs Georgia','4-1 vs Cyprus','2-0 vs Scotland','5-0 vs Andorra'], worldCupApps:17, bestResult:'冠军 (2010)', groupStageOdds:1.04, winOdds:5.0 },
  { id:'saudi-arabia', name:'沙特', nameEn:'Saudi Arabia', flag:'🇸🇦', group:'H', fifaRank:53, elo:1630, coach:'Roberto Mancini', keyPlayers:['Salem Al-Dawsari','Firas Al-Buraikan','Saud Abdulhamid'], recentForm:['W','L','W','D','L'], recentResults:['2-1 vs Qatar','0-3 vs Japan','3-0 vs Yemen','1-1 vs Oman','1-2 vs South Korea'], worldCupApps:7, bestResult:'16强 (1994)', groupStageOdds:5.50, winOdds:751 },
  { id:'uruguay', name:'乌拉圭', nameEn:'Uruguay', flag:'🇺🇾', group:'H', fifaRank:12, elo:1890, coach:'Marcelo Bielsa', keyPlayers:['Federico Valverde','Darwin Núñez','Ronald Araújo'], recentForm:['W','W','D','W','L'], recentResults:['2-0 vs Brazil','3-1 vs Bolivia','1-1 vs Colombia','2-0 vs Ecuador','0-1 vs Argentina'], worldCupApps:15, bestResult:'冠军 (1930, 1950)', groupStageOdds:1.20, winOdds:21 },
  { id:'cape-verde', name:'佛得角', nameEn:'Cape Verde', flag:'🇨🇻', group:'H', fifaRank:64, elo:1560, coach:'Bubista', keyPlayers:['Ryan Mendes','Jovane Cabral','Garry Rodrigues'], recentForm:['L','W','D','L','W'], recentResults:['0-2 vs Nigeria','2-1 vs Guinea','1-1 vs Angola','0-1 vs Egypt','2-0 vs Eswatini'], worldCupApps:1, bestResult:'小组赛', groupStageOdds:10.00, winOdds:2001 },

  // === GROUP I ===
  { id:'france', name:'法国', nameEn:'France', flag:'🇫🇷', group:'I', fifaRank:2, elo:2105, coach:'Didier Deschamps', keyPlayers:['Kylian Mbappé','Ousmane Dembélé','Aurélien Tchouaméni'], recentForm:['W','W','W','D','W'], recentResults:['3-0 vs Netherlands','2-0 vs Ireland','4-1 vs Greece','1-1 vs Germany','2-0 vs Belgium'], worldCupApps:17, bestResult:'冠军 (1998, 2018)', groupStageOdds:1.03, winOdds:5.0 },
  ...
  // === GROUP J ===
  { id:'argentina', name:'阿根廷', nameEn:'Argentina', flag:'🇦🇷', group:'J', fifaRank:1, elo:2135, coach:'Lionel Scaloni', keyPlayers:['Lionel Messi','Julián Álvarez','Enzo Fernández'], recentForm:['W','W','W','W','W'], recentResults:['2-0 vs Brazil','3-0 vs Bolivia','1-0 vs Paraguay','4-1 vs Chile','2-0 vs Peru'], worldCupApps:19, bestResult:'冠军 (1978,1986,2022)', groupStageOdds:1.04, winOdds:7.5 },
  { id:'austria', name:'奥地利', nameEn:'Austria', flag:'🇦🇹', group:'J', fifaRank:24, elo:1800, coach:'Ralf Rangnick', keyPlayers:['David Alaba','Marcel Sabitzer','Christoph Baumgartner'], recentForm:['W','W','W','W','D'], recentResults:['2-0 vs Germany','3-1 vs Sweden','2-0 vs Estonia','4-1 vs Azerbaijan','1-1 vs Belgium'], worldCupApps:8, bestResult:'季军 (1954)', groupStageOdds:1.50, winOdds:51 },
