    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-6 py-4">
          ...
          <p className="text-sm text-white/80">赔率越低，夺冠概率越高</p>
        </div>
                ...
                return (
                  <tr key={item.teamId} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4">
                      <span className={`text-xs font-bold ${idx < 5 ? 'text-orange-500' : 'text-gray-400'}`}>
                        {idx + 1}
                      </span>
                    </td>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6">
          ...
          <div className="space-y-3 text-sm text-gray-600">
            ...
            <div className="bg-gray-50 rounded-lg p-3 space-y-1.5">
              ...
              <p>→ 隐含概率 ≈ <span className="font-bold text-green-700">{Math.round(100/5.5)}%</span></p>
            </div>
            <p>赔率越低 = 市场认为夺冠概率越高</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6">
          ...
          <div className="space-y-2 text-sm text-gray-600">
            {championOdds.slice(0, 6).map((item, idx) => {
              ...
              return (
                <div key={item.teamId} className="flex items-center justify-between py-1.5 border-b border-gray-50 last:border-0">
                  <div className="flex items-center gap-2">
